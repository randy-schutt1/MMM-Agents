...
IN REMEDIATION:   2  (V07 — R1 REVISE 2026-08-13, 0 CRITICAL / 0 MAJOR /
                      3 MINOR (open items 61-63).
                      ...
                      video/v08 (d9e4f9e), which is NOT MERGED into the
                      integration branch. Merge-status and the D-038
                      ledger-location question are FLAGGED for the owner,
                      not resolved by the reviewer — V08_REVIEW_R1.md §3.)
AWAITING REVIEW:  0
```
