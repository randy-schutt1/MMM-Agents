...
IN REMEDIATION:   1  (V05 — R1 REVISE, 0 CRITICAL / 0 MAJOR / 6 MINOR;
                      all 6 MINORS APPLIED 2026-08-11, PENDING R2 VERIFICATION;
                      open item 39 (EMA 3 -> 2) and the dimension-B
                      re-disposition are NOT yet applied — the latter is
                      blocked on an owner ruling (open item 36);
