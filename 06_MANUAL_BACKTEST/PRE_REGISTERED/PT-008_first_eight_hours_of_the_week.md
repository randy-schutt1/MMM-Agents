...
```text
STATUS:      NON-CONFORMING UNDER D-035 — SUPERSEDED BY PT-026, 2026-08-13.
             ...
             and names the replacement window: W-C' = 2013-01-06 -> 2016-06-30. PT-026
             carries this test's question, measures, nulls, seed and decision rules onto
             ...
             substitution changes:
               - data source: HistData GBP/USD M1 CSV corpus (D-036a), not TradingView
                 / FXCM (D-034);
               - week open: 22:00 UTC (Sunday 17:00, fixed UTC-5, no DST), NOT the
                 21:00 UTC this file inherited from FXCM -- and this test is the one
                 most exposed to that change, because its block IS the first bars of
                 the week;
               - "the first eight hours" and "the first two 4-hour bars" are NO LONGER
                 THE SAME SPAN on the new corpus (PT-026 0c); both are reported and
                 neither is adopted;
               - sample: 180 TRADING weeks, not the ~260 claimed in 3 below. W-C' holds
                 ...
                 from Sun 2014-06-01 17:00 to Mon 2014-06-02 15:01 (~22 hours), so
                 that week has no observable week open and cannot carry this test.
                 Surfaced by QA check C8, which was ADDED AFTER PT-026 was drafted.

             THIS FILE HAS NEVER BEEN RUN AND MUST NOT BE RUN. Its blockers were never
             discharged; it is superseded before, not after, execution.
