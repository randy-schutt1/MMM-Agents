// tv_harvest_v06.mjs — harvest TIMESTAMPED OHLC bars from TradingView.
//
// V06 copy of the V05 harvester, unchanged in method. Retained verbatim rather than
// re-derived so the two lessons’ data are produced by the same instrument.
//
