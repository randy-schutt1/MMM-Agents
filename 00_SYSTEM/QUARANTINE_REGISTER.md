...
## 0. ⭐⭐ WHAT IS NEW HERE: THE PATTERN REVERTS TO A BYTE CLONE, AND `REVIEW_INDEX.md` ITEM 200'S PREDICTION IS **HALF RIGHT**

**Item 200**, raised by the V16 session, reads: *"`Q-017`'s detection note: the generator now
...
⭐ **WHAT THIS MEANS FOR DETECTION, AND IT IS THE OPPOSITE OF WHAT ITEM 200 EXPECTED.** The generator
...
V17 in one command. Item 200's warning is still correct in its narrow form — *a `diff` against V15
...
**Open item 201 carries this forward.**
