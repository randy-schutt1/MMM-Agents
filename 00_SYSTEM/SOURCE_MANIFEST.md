...
|---|---|---|---|---|
| A-01 | Week 6 | **Expected-but-missing lesson.** Session dates run 03/18, 03/25, 03/26, 04/01, 04/08, 04/15, then jump to 05/06. Weeks 1–5 and 7–10 are present; there is no Week 6 file and no gap-filling folder. ⭐ **V17 `[00:11:22]` supports the gap's shape:** *"we took an extra week in between"* (three-engine R1 correction, item 244). It does not date or reconstruct the absent lesson. | None. Confirmed by the project owner as genuinely absent from the source material, not a local copy error. **Do not fabricate, interpolate, or infer Week 6 content.** A future lesson referring back to "last week" from V15 is referring to material this library does not contain. | CLOSED — DOCUMENTED |
